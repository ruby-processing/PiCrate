...
public class PApplet implements PConstants {
    ...
    static {
        ...
        JAVA_PLATFORM = Integer.parseInt(version.substring(0, version.indexOf('.')));
    }
    ...
    /**
     * Current platform in use, one of the PConstants LINUX or OTHER.
     */
...
//      "properly set for using the OpenGL library.";
        ...
        try {
            PGraphics pg;
            // create a PGraphics instance with as little ceremony as possible
            pg = (PGraphics) Class.forName(renderer).getDeclaredConstructor().newInstance();
            pg.setParent(this);
...
//      } else {
            if (external) {
                throw new RuntimeException("You need to use \"load_library\" "
...
//      mousePressed = false;
  ...
  static public void print(Object what) {
     ...
     * of the array to the console. This is often helpful for looking at the
     * data a program is producing. A new line is put between each element of
     * the array. This function can only print one dimensional arrays. For
     * arrays with higher dimensions, the result will be closer to that of
     * <b>print()</b>.
     *
     * ( end auto-generated )
     *
...
//   */
 ...
 /*
  static public final double min(double[] list) {
     ...
     * returned as a
     * <b>float</b> in the range from <b>PI</b> to <b>-PI</b>. The
  ...
  static public final double map(double value,
     ...
     * be interpreted as time.<br><br>The actual noise is structured similar to
     ...
     * <br><br>Another way to adjust the character of the resulting sequence is
     * the scale of the input coordinates. As the function works within an
...
//  }
    ...
    protected PImage loadImageTGA(String filename) throws IOException {
        PImage outgoing;
        try ( InputStream is = createInput(filename)) {
            if (is == null) {
                return null;
            }
            ...
            outgoing = createImage(w, h, format);
...
//    println("ps: " + f.getPSName());
  ...
  private Frame selectFrame() {
     ...
     * 'callback' function. If the dialog is closed or cancelled, null will be
...
//  }
     ...
     * extract. If no <b>length</b> is given, elements will be extracted from
     * the
  ...
  static final public float[] parseFloat(char what[]) {
     ...
     * should always be positive integers.<br><br>As shown in the above example,
    ...
    protected PSurface initSurface() {
        ...
        public void setLocation(int x, int y) {
          ...
          surface.setLocation(x, y);
            ...
            surface.setTitle("PiCrate Sketch");
...
//    }
    /**
     * Convenience method for picrate to run an already-constructed sketch. This
     * makes it makes it easy to launch a sketch in jruby:
     *
    ...
    protected void runSketch(final String[] args) {
        ...
        argsWithSketchName[args.length] = className;
   ...
   * @param mode either OPEN, CHORD, or PIE
     ...
     * of
     * <em><a href="http://en.wikipedia.org/wiki/Tangent"target="new">tangent</a>
     * </em> on Wikipedia.
     *
     * ( end auto-generated )
     *
     ...
     * <br> Because fonts are usually bitmaped, you should create fonts at the
     ...
     * <br> With the default (JAVA2D) and PDF renderers, it's also possible to
     ...
     * calling <b>scale(2.0)</b>
     * and then <b>scale(1.5)</b> is the same as
     ...
     * <b>camera()</b> function will be sufficient.<br><br>The camera functions
     ...
     * current
     * <b>colorMode()</b> (the default color space is RGB, with each value in
     ...
     * with
     * <b>emissive()</b>, <b>ambient()</b>, and <b>shininess()</b> in setting
     ...
     * QUADRATIC)<br><br>Like <b>fill()</b>, it affects only the elements which
     ...
     * careful not to assign it to an int value.<br><br>The red() function is
     * easy to use and undestand, but is slower than another technique. To
     ...
     * null null null null     equivalent:<br><pre>float r1 = blue(myColor);<br>float r2 = myColor
   * &amp; 0xFF;</pre>
     *
     * ( end auto-generated )
     *
