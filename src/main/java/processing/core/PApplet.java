...
//  }
   ...
   * <br><br> structuring a program, it only makes sense to call redraw() within
   * events such as <b>mousePressed()</b>. This is because
...
//          event.getKeyCode() == 'W') {
   ...
   * may be opened by selecting "Show sketch folder" from the "Sketch" menu.<br>
   * <br>
   ...
   * higher dimensions, the result will be closer to that of
   * <b>print()</b>.
   *
   * ( end auto-generated )
   *
...
//   */
 ...
 /*
   ...
   * interpreted as time.<br><br>The actual noise is structured similar to an
   ...
   * <br> an image is not loaded successfully, the <b>null</b> value is returned
   * and an error message will be printed to the console. The error message does
   * not halt the program, however the null value may cause a
...
//    println("ps: " + f.getPSName());
   ...
   * 'callback' function. If the dialog is closed or cancelled, null will be sent
...
//  }
   ...
   * not to assign it to an int value.<br><br>The red() function is easy to use
   ...
   * components. For example, the following two lines of code are null   equivalent:<br><pre>float r1 = blue(myColor);<br>float r2 = myColor
   * &amp; 0xFF;</pre>
   *
   * ( end auto-generated )
   *
